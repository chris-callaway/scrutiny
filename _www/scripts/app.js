...
angular
    ...
    .config(function ($routeProvider) {
        ...
        function ($rootScope, $location, $cookieStore, $http) {
            ...
            $rootScope.serverEndpoint = "http://192.169.217.115:8080/~developer/Scrutiny/server";
            ...
            $rootScope.toggleSidebar = function () {
                if ($rootScope.globals.currentUser || $rootScope.accountCreate) {
            ...
            $rootScope.$on('$locationChangeStart', function (event, next, current) {
                ...
                if ($location.path() !== '/' && $location.path() !== '/account-create' && $location.path() !== '/reply' && $location.path() !== '/confirmation' && $location.path() !== '/privacy-policy' && $location.path() !== '/terms-of-use' && $location.path() !== '/main') {
                    $location.path('/');
                }
